...
const Checkout = () => {
  const { cart, removeFromCart, clearCart, updateQuantityItem } = useContext(CartContext);
  return (
    <div className="container">
      ...
      <div className="shadow-sm my-4">
        ...
        <button className="btn btn-success" type="button" onClick={() => clearCart()}>Limpiar carrito</button>
      </div>
